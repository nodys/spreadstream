...
/**
 * Transform a sheet row RAW values to json values (number and boolean)
 * @param  {Object} row Row values
 * @return {Object}     Row with json values parsed (number / boolean)
 */
